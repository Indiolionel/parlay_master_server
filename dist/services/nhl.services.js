...
class NhlService {
    ...
    static editarResumen(data, resumen) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const partido = yield nhl_1.default.findOneAndUpdate({ equipoLocal, equipoVisitante }, { resumen }, { new: true });
    ...
    static editarPick(data, pick) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { equipoLocal, equipoVisitante } = data;
                const partido = yield nhl_1.default.findOneAndUpdate({ equipoLocal, equipoVisitante }, { pick }, { new: true });
                return { success: true, data: partido };
            }
            catch (error) {
                console.error(error);
