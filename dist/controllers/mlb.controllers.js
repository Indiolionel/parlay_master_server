...
class MlbController {
    ...
    static editarResumen(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { partido, resumen } = req.body;
            const partidos = yield mlb_services_1.MlbService.editarResumen(partido, resumen);
            res.status(partidos.success ? 200 : 400).send(partidos);
        });
    }
    static editarPick(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { partido, pick } = req.body;
            const partidos = yield mlb_services_1.MlbService.editarPick(partido, pick);
            res.status(partidos.success ? 200 : 400).send(partidos);
        });
    }
